    ...
    <section className="py-16 px-4">
      <div className="mx-auto max-w-screen-xl">
        <div className="wac-card p-8 md:p-12 text-center relative overflow-hidden">
          ...
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(176,141,87,0.06)_0%,transparent_65%)] pointer-events-none" />

          <div className="relative z-10 max-w-md mx-auto">
            <h2 className="font-serif text-3xl md:text-4xl font-normal text-white mb-3 leading-snug">
              The network is early.{" "}
              <span className="italic text-[#b08d57]">Join it now.</span>
            </h2>
            ...
            <Link
              href="/login"
              className="inline-flex items-center justify-center px-8 py-3.5 rounded-full bg-[#b08d57] text-black text-sm font-bold hover:bg-[#9a7545] transition-colors"
            >
              Create Your Profile
            </Link>
          </div>
