    ...
    <div className="space-y-4">
      ...
      <div className="flex border-b border-[var(--border)] mb-4">
        <button
          ...
          className={`flex-1 py-3 text-center border-b-2 transition-all duration-300 ${
            activeTab === "foryou" ? "border-[var(--accent)]" : "border-transparent"
          }`}
        >
          {activeTab === "foryou" ? (
             <span className="font-serif font-bold italic text-[#D4AF37] tracking-tight text-xl pr-2 drop-shadow-[0_0_8px_rgba(212,175,55,0.4)] transition-all duration-300">
               For You
             </span>
          ) : (
             <span className="font-serif text-[#D4AF37] opacity-60 hover:opacity-100 text-sm italic font-bold transition-all duration-300">
               For You
             </span>
          )}
        </button>
        <button
          ...
          className={`flex-1 py-3 text-center border-b-2 transition-all duration-300 ${
            activeTab === "following" ? "border-[var(--accent)]" : "border-transparent"
          }`}
        >
          {activeTab === "following" ? (
             <span className="font-serif font-bold italic text-[#D4AF37] tracking-tight text-xl pr-2 drop-shadow-[0_0_8px_rgba(212,175,55,0.4)] transition-all duration-300">
