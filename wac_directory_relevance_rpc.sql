-- ==========================================
-- WAC People Directory Relevance Search RPC
-- ==========================================
-- This function replaces the in-memory sorting of the people directory
-- by mathematically scoring each user on the database side before returning.
-- It matches the `v_people_directory_enriched` view columns.
